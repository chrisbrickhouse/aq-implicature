...
# Load data
L0_data_file <- "~/Desktop/Linguistics/QP1/psycholing_results/PeloquinAndFrankReplicationData_Pilot.csv"
...
means = L0data %>%
  ...
  #mutate(AQ_bin=cut_number(as.numeric(baroncohen_aq),1)) %>%
...
#PF2016_data_file <- "~/Desktop/scalar_implicature/production-results/e12-anonymized-results/OGData.csv"
